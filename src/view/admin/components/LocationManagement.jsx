...
const LocationManagement = () => {
	...
	const [viewDetailDialog, setViewDetailDialog] = useState({ open: false, location: null });
	...
	const [selectedLocation, setSelectedLocation] = useState(null); // For map selection {lat, lng}
					...
					<Box sx={{ mt: 2, height: 300 }}>
						...
						>
							<TileLayer
								...
								url={`https://api.tomtom.com/map/1/tile/basic/main/{z}/{x}/{y}.png?key=${import.meta.env.VITE_TOMTOM_KEY}`}
							/>
							<MapClickHandler onMapClick={(latlng) => setSelectedLocation({ lat: latlng.lat, lng: latlng.lng })} />
			...
			<ConfirmDialog
				...
				message={
					confirmDialog.action === 'delete'
						? <>Are you sure you want to delete <strong>{confirmDialog.location?.location_name}</strong>? This action cannot be undone.</>
