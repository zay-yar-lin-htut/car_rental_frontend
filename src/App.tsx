...
import { UserRoleProvider, useUserRole, type UserRole } from "./contexts/userRoleContext";
...
const RoleProtectedRoute = ({ children, allowedRoles }: { children: ReactNode; allowedRoles: UserRole[] }) => {
